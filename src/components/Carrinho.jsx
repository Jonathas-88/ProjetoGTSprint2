                ...
                <tbody>
                    <tr className="flex border-t border-b border-[#968989] py-5 mt-5">
                        ...
                        <td className="flex-1 text-center flex items-center flex-col justify-center gap-4">
                            <div className="">
                                <button disabled={count <= 0} onClick={()=> setCount(count - 1)} className={`${count <= 0 ? "opacity-50 cursor-not-allowed": "cursor-pointer"} border border-[#ccc] w-8 rounded-sm h-8`}>-</button>
                                <span className="mx-2">{count}</span>
                                <button onClick={()=> setCount(count + 1)} className="border border-[#ccc] w-8 rounded-sm h-8 cursor-pointer">+</button>
                            </div>
