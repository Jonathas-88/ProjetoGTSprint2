...
const Carrinho = () => {
  const { count, addToCart, removeFromCart, removeItem } =
        ...
        <table className="w-full font-inter">
          <thead>
            <tr className="flex text-[#474747] bg-primary">
              ...
              <th className="flex-1 font-medium">UNITÁRIA</th>
              <th className="flex-1 font-medium">TOTAL</th>
            </tr>
          </thead>
          <tbody>
            {count > 0 && (
              <tr className="flex border-t border-b border-[#968989] py-5 mt-5">
                <td className="flex-3 flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="mt-[10px] mb-[5px]">
                      <span className="text-[#8F8F8F]">Cor:</span> Vermelho /
                      Branco
                    </p>
                    <p>
                      <span className="text-[#8F8F8F]">Tamanho:</span>42
                    </p>
                  </div>
                </td>
                <td className="flex-1 text-center flex items-center flex-col justify-center gap-4">
                  <div className="">
                    <button
                      ...
                      className={`${
                        count <= 0
                          ...
                          : "cursor-pointer"
                      } border border-[#ccc] w-8 rounded-sm h-8`}
                    >
                      -
                    </button>
                    ...
                    <button
                      onClick={addToCart}
                      className="border border-[#ccc] w-8 rounded-sm h-8 cursor-pointer"
                    >
                      +
                    </button>
                  </div>
                  <button
                    onClick={removeItem}
                    className="text-[#474747] underline cursor-pointer"
                  >
                    Remover item
                  </button>
                </td>
